...
namespace AuroraHRMPWA.Server.Migrations
{
    ...
    [Migration("20220403080311_Qualifications")]
            ...
            modelBuilder.Entity("AuroraHRMPWA.Shared.Qualification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CompletionStatus = 0,
                            EndDate = new DateTime(2022, 4, 3, 16, 3, 10, 827, DateTimeKind.Local).AddTicks(9680),
                            InstitutionName = "University of Malaya",
                            Major = "Computer Science",
                            QualificationName = 1,
                            Result = "3.62",
                            StartDate = new DateTime(2022, 4, 3, 16, 3, 10, 827, DateTimeKind.Local).AddTicks(9672),
                            UserId = 29
                        });
                });
